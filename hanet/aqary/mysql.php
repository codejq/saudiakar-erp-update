...
namespace {
    ...
    if (!extension_loaded('mysql')) {
        ...
        // Disable mysqli exception throwing for PHP 8+ compatibility
        // This makes mysqli behave like PHP 7 where errors are stored instead of thrown
        ...
        function mysql_connect(
            ...
            if ($flags === 0) {
                ...
                \Dshafik\MySQL::$connection_hashes[spl_object_id($conn)] = $hash;
        ...
        function mysql_close(?\mysqli $link = null)
        {
            ...
            $hash = \Dshafik\MySQL::$connection_hashes[spl_object_id($link)] ?? null;

            if ($hash && isset(\Dshafik\MySQL::$connections[$hash])) {
                \Dshafik\MySQL::$connections[$hash]['refcount'] -= 1;
            }

            $return = true;
            if ($hash && \Dshafik\MySQL::$connections[$hash]['refcount'] === 0) {
                $return = mysqli_close($link);
                unset(\Dshafik\MySQL::$connections[$hash]);
                unset(\Dshafik\MySQL::$connection_hashes[spl_object_id($link)]);
            }
...
namespace Dshafik {
    ...
    class MySQL
    {
        ...
        public static $connection_hashes = array(); // Maps connection object ID to hash
