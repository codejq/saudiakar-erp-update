<style>
   ...
   <div class=" uifont20 center" style="font-size: 20px;padding-bottom: 6mm;padding-top: 6mm;"> 
   فاتورة ضريبية رقم:
   <span style="font-weight: bold;color:red">{_رقم_السند_}</span>
            </div>
...
<table border="0"  class="invoice-table" align="center" class="tablefont1818 bluefont"
    ...
    <tr>
        <td style="width:20mm">
            <div class="invoice-body invoice-head center">رقم
                <div>
        </td>
        <td style="width:90mm">
    ...
    <tr>
        <td style="width:20mm;">
            <div class="invoice-body invoice-items">&nbsp;1
                <div>
        </td>
        <td style="width:90mm">
        ...
        <td>
            <div class="invoice-body invoice-items ">{_ضريبة_القيمة_المضافة_0}
                <div>
        </td>
        <td>
    ...
    <tr>
        ...
        <td>
            <div class="invoice-body   invoice-foot">{_اجمالي_الفاتورة_}
                <div>
        </td>
        <td>
            <div class="invoice-body   invoice-foot">{_ضريبة_القيمة_المضافة_}
                <div>
        </td>
        <td>
...
<table border="0"  align="center" class="tablefont1818 bluefont"
    ...
    <tbody>
    <tr>
        <td style="width:40mm;text-align:right;vxertical-align: text-top;">حالة السداد</td>
        <td style="text-align:center;width:130mm;border-bottom:1px dashed #000000"> {payment_status_ar}</td>
        <td style="width:40mm;text-align:left;vxertical-align: top;"> Payment Status</td>
    </tr>
